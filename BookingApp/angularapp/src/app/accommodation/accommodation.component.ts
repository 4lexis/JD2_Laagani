...
export class AccommodationComponent implements OnInit {
  ...
  @Input() accType: AccommodationTypeComponent;
  ...
  constructor(
    ...
    private accTypeService: AccommodationTypeService,
  ...
  onSubmit(accommodation: Accommodation, form: NgForm) {
    if (form.valid) {
      ...
      // accommodation.ImageURL = this.ImageUrl; 
      //debugger
      console.log(accommodation);
      
      this.accService
        .create(accommodation)
        .then(() => this.getAccommodations());
      form.resetForm();
    } else {
